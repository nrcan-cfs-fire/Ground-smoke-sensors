...
funding: |
  The United States Department of Homeland Security purchased the sensors from the vendor, and provided in-kind support for travel and sensor deployment operations.
dataavailability: |
  Hotspot tabular data and corresponding daytime visible imagery are available at [***[Insert in progress Zenodo record]***]
conflictsofinterest: |
