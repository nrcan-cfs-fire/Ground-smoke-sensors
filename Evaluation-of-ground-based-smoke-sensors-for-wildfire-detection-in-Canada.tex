...
With the recent availability of commercial vendors making such
distributed small sensor systems available to communities or fire
management agencies, n field evaluation of smoke-detecting ground
...
varying terrain across Canada. This study represents the first large
...
of a fire detection and monitoring program. All fires consisted of
...
compound (VOC) concentrations, and report data every 5 minutes. PM and
...
related to both human health impacts \citep{matz2026} as well as fire
suppression operations challenges related to reduced visibility due to
wildfire smoke \citep{brambilla2025}. Sensors are powered by solar
...
\(\mu\)g/m\textsuperscript{3} and alerts as observations exceeding 200
\(\mu\)g/m\textsuperscript{3}. A web portal allowed stakeholders to
...
large and fast-growing fires. Visual detection potential was estimated
using two model used in conjunction: modelled fire growth and energy
output from the Canadian Forest Fire Behaviour Prediction System
...
sized fires \citep{tory2018}. Since detailed fire growth records over
...
\citep{taylor2018}, with similar accuracy in models of FRP and plume
heights, resulting in a larger, compounded error rates well above 20\%
for those estimates. The relationship between plume rise height,
...
possible well over 25 km given clear line of sight and favourable
atmospheric conditions (see Appendix F). Thus, any comparison to plume
heights is merely for reference, as visual detection modes are very
efficient in populated areas.
...
detection). For each fire, the ground-reported ignition time (both
...
experienced a rapid increase from ambient PM\textsubscript{2.5}
concentrations of \textless10 \(\mu\)g/m\textsuperscript{3} to 3,260
\(\mu\)g/m\textsuperscript{3} at a sensor location 1.8 km downwind. PM
concentrations continued to be elevated above 100
\(\mu\)g/m\textsuperscript{3} for an additional 4 hours. GOES fire
...
\(\mu\)g/m\textsuperscript{3} were detected in this dispersed
...
excess of 200 \(\mu\)g/m\textsuperscript{3} were detected.
...
\begin{verbatim}
##  [1] "2010$\\pm$800" "120$\\pm$50"   "240$\\pm$100"  "1230$\\pm$490"
##  [5] "440$\\pm$180"  "150$\\pm$60"   ""              ""             
##  [9] ""              "2 $\\pm$ 0.8"  ""              ""             
## [13] ""              ""              ""              ""             
## [17] ""              ""              ""              "200$\\pm$80"
\end{verbatim}
...
area, at concentrations as high as 5,000 \(\mu\)g/m\textsuperscript{3}
(Figure \ref{fig:WR_all_alerts}). Concentrations of
PM\textsubscript{2.5} have been registered as high as 20,000
\(\mu\)g/m\textsuperscript{3} at the immediate perimeter of fires by
...
PM\textsubscript{2.5} of less than 800 \(\mu\)g/m\textsuperscript{3}.
...
excess of 300 \(\mu\)g/m\textsuperscript{3} observed. Short duration and
low concentration (\textless50 \(\mu\)g/m\textsuperscript{3} smoke
events) were only observed at distances of 5 km or less; smoke events
observed closer were both of longer duration and higher concen
...
Figure A3). However, visual detection observations were not undertaken
...
Under widespread regional smoke or overcast conditions, the visual
...
schemes such as \citet{chenFireWorkV20Air2019}. These regional,
...
Sgt.~Korosi and his team at the CF Detachment Wainwright for their
